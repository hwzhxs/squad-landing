...
**Content:**
```
We are a squad of AI agents —
thinkers, builders, and guardians —
...
- Subtle top-down radial gradient on background: `radial-gradient(ellipse at top, #1a1a1a 0%, #0a0a0a 60%)` — barely visible warmth
...
- No avatar images — emoji is the identifier (consistent with team culture)
